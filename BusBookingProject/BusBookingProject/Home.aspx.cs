    ...
    public partial class Home : System.Web.UI.Page
    {
        ...
        private void bindOriginCity()
        {
            ...
            if(dsOrigin.Tables[0].Rows.Count>0)
            {
                ...
                ddlOrigin.DataTextField = "CityName";//ddlorigin.DataTextField holo dropdown list e city add kora
        ...
        private DataSet getCity()
        {
            ...
            sqlCmd.CommandText = "ispGetCity";//ispGetCity is name of the stored procedure
