                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlBank" runat="server" class="form-control input-sm floatlabel">
                                ...
                                <asp:ListItem Value="1" Text="ASIA BANK"></asp:ListItem>
                                <asp:ListItem Value="2" Text="PRIME BANK"></asp:ListItem>
                                <asp:ListItem Value="3" Text="AGRANI BANK"></asp:ListItem>
                                <asp:ListItem Value="4" Text="JANATA BANK"></asp:ListItem>
                                <asp:ListItem Value="5" Text="PUBALI BANK"></asp:ListItem>
                            </asp:DropDownList>
